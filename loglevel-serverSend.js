...
var loglevelServerSend = function loglevelServerSend(logger, options) {
    ...
    _logger.methodFactory = function (methodName, logLevel) {
        ...
        return function (message) {
            if (typeof _prefix === 'string') message = _prefix + message;else if (typeof _prefix === 'function') message = _prefix(methodName, message);else message = methodName + ': ' + message;
    ...
    var _sendNextMessage = function _sendNextMessage() {
